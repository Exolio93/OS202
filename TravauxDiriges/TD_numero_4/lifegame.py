...
class App:
    ...
    def draw(self,a,b):
        ...
        [self.screen.fill(self.compute_color(i,j),self.compute_rectangle(i,j)) for i in range(a,b) for j in range(self.grid.dimensions[1])]
...
if __name__ == '__main__':
    ...
    n = grid.dimensions[0] // comm_size
    a = rank * n
    b = a + n if rank < comm_size - 1 else grid.dimensions[0]
    print("rank ", rank, a, b)
